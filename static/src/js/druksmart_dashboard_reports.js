            ...
            () => {
                if (this.props.record.data.dashboard_data) {
                    try {
                        ...
                        this.state.main_data.sales = [];
                        this.state.main_data.total_sales_local_untaxed = 0;
                        this.state.main_data.total_sales_export_untaxed = 0;
                        this.state.main_data.revenues = [];
                        this.state.main_data.total_local_revenue_untaxed = 0;
                        this.state.main_data.total_export_revenue_untaxed = 0;
                        this.state.main_data.expenses = [];
                        this.state.main_data.total_local_expense_untaxed = 0;
                        this.state.main_data.total_export_expense_untaxed = 0;
                        this.state.main_data.cashflows = [];
                        this.state.main_data.total_local_cashflow_inflow = 0;
                        this.state.main_data.total_export_cashflow_inflow = 0;
                        this.state.main_data.total_local_cashflow_outflow = 0;
                        this.state.main_data.total_export_cashflow_outflow = 0;
                        this.state.main_data.net_local_cashflow = 0;
                        this.state.main_data.net_export_cashflow = 0;
                        this.state.main_data.total_net_cashflow = 0;

                        // Populate data based on what's available
                        if (parsedData.sales_data) {
